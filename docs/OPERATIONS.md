...
```text
host.sqlite3   schema v6 event journal, Task projection, namespaced extension-state pointers, leases, event-object references, durable board-message pointers, and CAS validation cache
