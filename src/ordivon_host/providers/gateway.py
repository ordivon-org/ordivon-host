...
from ..cognition.context import CompiledContext, DecisionKind
from ..cognition.decision import ModelDecision
...
ModelAdapter = ModelGateway


class ScriptedPreferenceAdapter:
    gateway_id = "scripted-preference-v1"
    ...
    def evidence_metadata(self) -> dict[str, JsonValue]:
        return {"gateway": "scripted-preference", "physicalProviderCall": False}
...
class CodexCliModelGateway:
    def __init__(
        ...
        *,
        ...
        self.gateway_id = f"codex-cli-ephemeral-v3:{model or 'configured'}"
        self.adapter_id = self.gateway_id
...
class HermesCliModelGateway:
    ...
    def __init__(
        ...
        *,
        ...
        self.executable = executable
        self.timeout_seconds = timeout_seconds
        self.gateway_id = f"hermes-cli-isolated-v3:{provider}/{model}"
        self.adapter_id = self.gateway_id
        self._last_evidence: dict[str, JsonValue] | None = None
...
CodexCliModelAdapter = CodexCliModelGateway
HermesCliModelAdapter = HermesCliModelGateway
